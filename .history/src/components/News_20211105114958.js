...
//    const [page , setPage] = useState(1)
    ...
    handlePrevClick = async () => {  
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}country=${this.props.country}&apiKey=6a6b787c519a4d56930d8ba4f5c08949&page=${this.state.page}&pageSize=${props.pageSize}`;
